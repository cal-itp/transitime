...
public abstract class AbstractServer {
		...
		try {
			...
			if (registry == null) {
				try {
					...
					logger.info("Exception occurred when trying to create " +
	 ...
	 */
    private void rebind() {
        logger.info("Trying to rebind {} to RMI registry.", bindName);
        ...
        try {
			...
			logger.info("Successfully rebound {} to RMI registry.", bindName);
