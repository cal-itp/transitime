...
public class ScheduleBasedHistoricalAverageCache {
	...
	private static ScheduleBasedHistoricalAverageCache singleton = null;
	private static Logger logger = null;
	final URL xmlConfigUrl = getClass().getResource("/ehcache.xml");
	private Cache<StopPathCacheKey, HistoricalAverage> cache = null;

	static {
		logger = LoggerFactory.getLogger(ScheduleBasedHistoricalAverageCache.class);
		logger.info("ScheduleBasedHistoricalAverageCache.static()");

		cacheName = "HistoricalAverageCache";
		logger.info("- cacheName: {}", cacheName);
		singleton = new ScheduleBasedHistoricalAverageCache();
	...
	private ScheduleBasedHistoricalAverageCache() {
		logger.info("ScheduleBasedHistoricalAverageCache.ScheduleBasedHistoricalAverageCache()");
